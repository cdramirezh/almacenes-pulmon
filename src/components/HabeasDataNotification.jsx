        ...
        <div className="habeas-data">
            {showNotification && 
                <div className="wrapper">
                    <p>Nuestro sitio web emplea cookies con el fin de brindarle un mejor servicio y garantizar una grata experiencia. Al seguir navegando, está aceptando la política de cookies. <a href="#" target="_blank" rel="noreferrer">Ver más</a></p>
