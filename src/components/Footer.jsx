    ...
    return (
        <footer className="footer">
                ...
                <Container fluid>
                    <Row>
                        <a href="https://www.decorceramica.com" target="_blank" rel="noreferrer">
                            <Image src='https://decorceramica.wpengine.com//LogoDECORBLANCO2024.png' />
                        </a>
                    </Row>
                    <Row className="d-none d-lg-flex desktop">
                        ...
                        <Col>
                            ...
                            <ul>
                                <li>
                                    <a href="https://entregabodega.grupodecor.com/" target="_blank" rel="noreferrer">Reserva de Citas recogida en Bodega</a>
                                </li>
                                <li>
            ...
            <div className="bottom">
                <a href="https://clovit.com/" target="_blank" rel="noreferrer">Desarrollado por Clovit</a>
            </div>
        </footer>
    )
}
